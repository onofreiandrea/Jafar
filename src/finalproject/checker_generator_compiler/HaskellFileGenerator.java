...
public class HaskellFileGenerator {
    ...
    public void buildAndRunHaskell(String filename) throws IOException, ParseException {
        ...
        PrintWriter fileWriter = new PrintWriter(new File(RUN_OUT, filename + ".txt"));
