...
public class Assembler {
	...
	private static class ILOCWalker extends ILOCBaseListener {
		...
		@Override
		public void exitSingleInstr(ILOCParser.SingleInstrContext ctx) {
		...
		@Override
		public void exitComment(ILOCParser.CommentContext ctx) {
		...
		@Override
		public void exitRealOp(ILOCParser.RealOpContext ctx) {
			ILOCParser.OpCodeContext opCodeTree = ctx.opCode();
		...
		@Override
		public void exitProgram(ILOCParser.ProgramContext ctx) {
			for (ILOCParser.InstrContext instr : ctx.instr()) {
		...
		@Override
		public void exitSources(ILOCParser.SourcesContext ctx) {
			List<Operand> result = new ArrayList<>();
		...
		@Override
		public void exitTargets(ILOCParser.TargetsContext ctx) {
			List<Operand> result = new ArrayList<>();
			for (ParseTree o : ctx.operand()) {
				result.add(getOperand(o));
			}
		...
		@Override
		public void exitOperand(ILOCParser.OperandContext ctx) {
			Operand result;
			if (ctx.STR() != null) {
